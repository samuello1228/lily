...
From VUV photolysis experiments of Gans et al. (2011)\cite{gans2011photolysis}, CH$_2$ is more abundant than CH$_3$. However, EUV photodissociation experiments of Tsai and Eland (1980)\cite{tsai1980mass} CH$_3$ is more abundant than CH$_2$. Based on these two experimental results, we may conclude that fragment yields of CH$_4$ dissociation is photon energy dependent and more CH$_2$ than CH$_3$ is obtained in VUV range while more CH$_3$ should be obtained in EUV range in gas phase experiments. However, our results shows more C$_3$H$_8$ is formed when we use EUV photons as irradiation source. This unexpected contradiction is mainly because the peak C$_3$H$_8$ is only an tentative assignment which consists of longer carbon chain substances like butane and hexane, these molecules contribute to the same absorption bands.\\
